...
// Source: github.com/ozoncp/ocp-timeline-api/internal/repo (interfaces: Repo)
...
import (
	...
	models "github.com/ozoncp/ocp-timeline-api/internal/models"
)
...
func (m *MockRepo) AddEntities(arg0 context.Context, arg1 *models.Timeline) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 context.Context, arg1 uint64) (*models.Timeline, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeEntity", arg0, arg1)
	ret0, _ := ret[0].(*models.Timeline)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepo) ListEntities(arg0 context.Context, arg1, arg2 uint64) ([]models.Timeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) UpdateEntity(arg0 context.Context, arg1 *models.Timeline) (bool, error) {
	m.ctrl.T.Helper()
