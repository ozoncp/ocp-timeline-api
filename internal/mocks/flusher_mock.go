...
// Source: github.com/ozoncp/ocp-timeline-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Timeline) []models.Timeline {
	m.ctrl.T.Helper()
